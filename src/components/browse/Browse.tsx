  ...
  return (
    <div className="browse">
      <div className="browse__heading">
        ...
        <button
          className="browse__add"
          onClick={() => {
            toggleNoScroll(true)
            setAddBookFormVisibility(true)
          }}
        >
          Add Book
        </button>
      </div>
      <div className="browse__filter"></div>
      <div className="books">
            ...
            return (
              ...
              >
                <img
                  ...
                  className={`book__cover ${currentBook?.isbn === book.isbn ? 'book__selected' : ''} `}
                />
